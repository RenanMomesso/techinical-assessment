...
const mockUsePlanetsQuery = usePlanetsQuery as jest.MockedFunction<
  typeof usePlanetsQuery
>;
...
describe("Dashboard", () => {
  ...
  it("renders dashboard with planets table", () => {
    ...
    expect(
      screen.getByText("🌌 Star Wars Planets & Residents Dashboard")
    ).toBeInTheDocument();
